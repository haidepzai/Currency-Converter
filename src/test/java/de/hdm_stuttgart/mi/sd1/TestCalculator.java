...
public class TestCalculator {
    ...
    public void testSetAmountToBuy() {
        assertEquals(23.45, Calculator.setAmountToBuy(23.446756), 0.00001);
        assertEquals(-23.45, Calculator.setAmountToBuy(-23.4451), 0.00001);
    ...
    public void testConvertingAmount() {
        ...
        assertEquals(11.38, Calculator.convertingAmount(10, 1.2181, 1.38583), 0.00001);
        //Test for buying 100 Australian Dollar in Chilean Peso
        assertEquals(49254.19, Calculator.convertingAmount(100, 1.92771, 949.478), 0.00001);
